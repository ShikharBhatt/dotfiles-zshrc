# Generated by Powerlevel10k configuration wizard on 2020-05-03 at 21:44 IST.
...
() {
  ...
  typeset -g POWERLEVEL9K_LINUX_ICON='%F{blue}\uf303 %F{black}arch%F{blue}linux%f'
  
  typeset -g DEFAULT_USER=hostname
  typeset -g POWERLEVEL9K_ALWAYS_SHOW_CONTEXT=true
  typeset -g POWERLEVEL9K_CONTEXT_DEFAULT_FOREGROUND='green'
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE="%F{cyan}\uf2be %F{cyan}%n%f"
